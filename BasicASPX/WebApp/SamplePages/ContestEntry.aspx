...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- validation controls 
        ...
        belong to
        SetFocusOnError place cursor on contrrol if invalid
    ...
    <asp:RequiredFieldValidator ID="RequiredStreetAddress2" runat="server" ErrorMessage="Street Address 2 is Required"
    ...
    <%--Validation Expression holds the pattern the input string
        data must match--%>
    <asp:RegularExpressionValidator ID="RegularExpressionPostalCode" runat="server" ErrorMessage="Invalid postal code (sample T6T 6T6)"
        ControlToValidate="PostalCode" SetFocusOnError="true"
